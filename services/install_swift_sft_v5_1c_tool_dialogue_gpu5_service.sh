...
SERVICE_NAME="swift-sft-v5-1c-tool-dialogue-gpu5.service"
SERVICE_DIR="$HOME/.config/systemd/user"
SERVICE_FILE="$SERVICE_DIR/$SERVICE_NAME"
ENV_FILE="$PROJECT_ROOT/services/swift-sft-v5-1c-tool-dialogue-gpu5.env"
LOG_DIR="$PROJECT_ROOT/tracking/logs"
SERVICE_LOG="$LOG_DIR/swift_sft_v5_1c_tool_dialogue_gpu5.service.log"
...
[Unit]
Description=Swift GPU5 v5.1c Tool-Dialogue Knowledge Gate Repair SFT + Gate
