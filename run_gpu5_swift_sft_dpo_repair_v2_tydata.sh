...
SFT_DATA_FILE=${SFT_DATA_FILE:-/home/ubuntu/qwen35a3b_finetune/datasets/sft_openai_messages.cleaned.v3_merged.single75_exact.repair_v2.tydata.jsonl}
DPO_DATA_FILE=${DPO_DATA_FILE:-/home/ubuntu/qwen35a3b_finetune/datasets/dpo_pairs.repair_v2.tydata.jsonl}
BASE_MODEL=${BASE_MODEL:-Qwen/Qwen3.5-35B-A3B}

SFT_RUN_NAME=${SFT_RUN_NAME:-swift_sft_repair_v2_tydata_gpu5_${TS}}
SFT_OUT_DIR=${SFT_OUT_DIR:-/home/ubuntu/qwen35a3b_finetune/outputs/${SFT_RUN_NAME}}

DPO_RUN_NAME=${DPO_RUN_NAME:-swift_dpo_repair_v2_tydata_gpu5_${TS}}
