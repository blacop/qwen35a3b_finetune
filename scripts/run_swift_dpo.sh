...
# DATA_FILE=./datasets/dpo_pairs.jsonl \
# OUT_DIR=./outputs/swift_dpo \
# REPORT_TO="tensorboard mlflow" \
# AUTO_RESUME=true \
# RESUME_FROM_CHECKPOINT=./outputs/swift_dpo/checkpoint-200 \
# ./run_swift_dpo.sh
...
OUT_DIR=${OUT_DIR:-/home/ubuntu/qwen35a3b_finetune/outputs/swift_dpo}
...
COLUMNS=${COLUMNS:-'{"prompt":"query","chosen":"response","rejected":"rejected_response"}'}
