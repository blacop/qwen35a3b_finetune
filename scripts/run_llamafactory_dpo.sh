...
# Usage:
# BASE_MODEL=Qwen/Qwen3.5-35B-A3B SFT_CKPT=./outputs/lf_sft DATA_FILE=./datasets/dpo_pairs.jsonl OUT_DIR=./outputs/lf_dpo ./run_llamafactory_dpo.sh

BASE_MODEL=${BASE_MODEL:-Qwen/Qwen3.5-35B-A3B}
SFT_CKPT=${SFT_CKPT:-/home/ubuntu/qwen35a3b_finetune/outputs/lf_sft}
DATA_FILE=${DATA_FILE:-/home/ubuntu/qwen35a3b_finetune/datasets/dpo_pairs.jsonl}
DATASET_NAME=${DATASET_NAME:-dpo_pairs}
OUT_DIR=${OUT_DIR:-/home/ubuntu/qwen35a3b_finetune/outputs/lf_dpo}
...
RUN_NAME=${RUN_NAME:-lf_dpo_qwen35}
